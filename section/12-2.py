...
# DB 파일 조회(없으면 새로 생성)
conn = sqlite3.connect('/home/runner/Fastcam-py/resource/database.db')  # 본인 DB 파일 경로
...
with conn:
    ...
    with open('/home/runner/Fastcam-py/resource/dump.sql', 'w') as f:
